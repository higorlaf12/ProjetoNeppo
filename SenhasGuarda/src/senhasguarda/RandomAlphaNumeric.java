...
public class RandomAlphaNumeric {
    private static final Random aliatorio = new Random();
    ...
    public static char randomChar() {
        return toChar(aliatorio.nextInt(62));
    }
    ...
    public static String randomString(int minLength, int maxLength) {
        ...
        int size = minLength + aliatorio.nextInt(maxLength-minLength+1);
        return randomString(size);
    }
    // Como usar System.out.println(RandomAlphaNumeric.randomString(100));
}
